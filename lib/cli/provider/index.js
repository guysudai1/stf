...
module.exports.builder = function(yargs) {
  ...
  var remoteAdb = require('../../util/remote-adb-scanner')
  ...
  return yargs
    ...
    .option('remote-adb-subnet', {
      describe: 'IPv4 CIDR to scan for ADB-over-TCP devices.'
    , type: 'string'
    , coerce: function(value) {
        return remoteAdb.normalizeCIDR(value).cidr
      }
    })
    .option('remote-adb-ports', {
      describe: 'Comma-separated ADB-over-TCP ports to scan (default: 5555).'
    , type: 'string'
    , default: '5555'
    , coerce: remoteAdb.parsePorts
    })
    .option('remote-adb-scan-interval', {
      describe: 'Seconds between remote ADB scans (default: 300).'
    , type: 'number'
    , default: 300
    , coerce: function(value) {
    ...
    .check(function(argv) {
      remoteAdb.validateConfig({
        subnet: argv.remoteAdbSubnet
      , ports: argv.remoteAdbPorts
      , intervalSeconds: argv.remoteAdbScanInterval
      })
      return true
    })
...
module.exports.handler = function(argv) {
  ...
  var remoteAdbConfig = require('../../util/remote-adb-scanner').validateConfig({
    subnet: argv.remoteAdbSubnet
  , ports: argv.remoteAdbPorts
  , intervalSeconds: argv.remoteAdbScanInterval
  })
  ...
  , allowRemote: argv.allowRemote || remoteAdbConfig.enabled
  , remoteAdbSubnet: remoteAdbConfig.enabled ? remoteAdbConfig.subnet.cidr : null
  , remoteAdbPorts: remoteAdbConfig.ports
  , remoteAdbScanInterval: remoteAdbConfig.intervalSeconds
